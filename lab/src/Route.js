    ...
    return(
        <div className="Route">
            <header className="Route-header">
                <h1>Route</h1>
                <TextBox type="text" label={"Start Latitude"} change={setStartLat} />
                <TextBox type="text" label={"Start Longitude"} change={setStartLong}/>
                <TextBox type="text" label={"End Latitude"} change = {setEndLat}/>
                <TextBox type="text" label={"End Longitude"}change={setEndLong} />
